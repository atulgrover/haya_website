# Qualification Pack: Battery System Assembly Operator
**QP Code**: `ELE/Q6604`  
...
12th grade Pass
OR
Certificate-NSQF (Level-3 in the domain of EV /
Electrical / Mechanical / Automobile) with 2
Years of experience
...
Planning for the assembly 14 33 - -
PC1. interpret the design and connectivity
1 4 - -
requirement
PC2. establish the inter-operability between
1 3 - -
various components of the system
PC3. select components of the battery system
such as integrated circuit, busbar etc. as per 1 3 - -
design
PC4. determine temperature monitoring sensor
for energy storage system (ESS) and portable 1 3 - -
applications
PC5. choose the functional blocks of the battery
system including battery authentication, a real- 1 3 - -
time clock, memory etc.
PC6. deduce security aspects to be included at
2 3 - -
all stages of the assembly
PC7. use necessary structure for shock
2 3 - -
absorption
PC8. deploy provisions for removal of harmful
1 3 - -
gas, excess heat etc.
PC9. examine the possibility of high voltage
2 4 - -
short circuit
PC10. plan the assembly as per quality, industry
2 4 - -
and compliance standards
Assembling the Battery system 16 37 - -
PC11. match voltage, capacity and internal
1 2 - -
impedance of the cells
PC12. group cells with similar operating
1 3 - -
parameters
PC13. join cells in series strings and string in
1 3 - -
parallel as per standard operating procedure
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC14. assemble modules and attach slave
1 3 - -
Battery Management System (BMS)
PC15. test the modules after assembly 1 3 - -
PC16. stack modules in series and parallel
1 3 - -
combination to achieve final configuration
PC17. place the battery pack in enclosure 2 4 - -
PC18. attach master Battery Management
2 4 - -
System with the battery pack
PC19. test the pack for quality assurance 2 4 - -
PC20. store the packs in FIFO (First In First Out)
2 4 - -
mode at 50% State of Charge (SOC)
PC21. maintain the necessary climatic condition 2 4 - -
#### NOS Total 30 70 - -
...
etc.
KU11. methods to carry out battery pack testing such as impedance spectroscopy tests, thermal
tests, vibration tests etc.
Generic Skills (GS)
User/individual on the job needs to know how to:
...
procedure
PC12. retest the battery system to ensure that
3 7 - -
...
ELE/N6604.Assemble the
30 70 - - 100 25
Battery system
ELE/N6605.Test the Battery
30 70 - - 100 25
system assembly
