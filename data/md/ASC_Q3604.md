# Qualification Pack: Automotive Assembly Operator
**QP Code**: `ASC/Q3604`  
...
9th Class
OR
Certificate-NSQF (Level 2 (Automotive
Assembly Assistant) with 2 Years of
...
requirements
PC3. check the tools and equipment for any defects
1 2 - 1
before use
PC4. check and clean the assembling equipment of
1 2 - 1
any dust and impurities
PC5. follow safety practices during assembly
1 1 - 1
process as per organisational SOP
PC6. fill CLRI (Clean, lubricate, retighten &
inspection) check sheet and report to the 1 3 - 1
supervisor about any abnormalities identified
...
instructions
PC8. support the assembly technician in inspecting
and marking the defects if any, such as in paint,
2 2 - 2
dents, grooves, cracks, rough edges etc. on the
physical body of the auto component
Support in assembly operations 8 19 - 5
PC9. support in setting of the equipment as per the
1 2 - -
selected assembly method
PC10. support in assembly operations and
assemble the safety parts i.e. bearings, shafts etc.,
electrical semi-precision parts such as electric wire
3 7 - 2
harness, Electronic Control Unit (ECU), automatic
lock system, fuel injection system and other similar
parts
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC11. support in installation of the Oil and Lube
...
Instructions/ SOPs/Control Plans
PC12. carry out sealing of the required areas to
prevent any leakage of water/air etc. during the 1 3 - 1
usage of the component
PC13. carry out labeling on the auto components
specifying the information related to assembly 1 2 - 1
process and IATF- 16949 standards followed
Support in post-assembly operations 5 12 - 4
PC14. apply appropriate lubricant on the
1 2 - 1
component as per manufacturer's specifications
PC15. check and confirm that water, diesel or
1 3 - 1
petrol, brake oil, gear oil, engine oil etc. are filled
PC16. support in checking the assembled auto
components as per the control plan, work 1 3 - -
instructions for product quality
PC17. store the tools, equipment and fixtures by
following organisational policies and procedures 1 2 - 1
after completion of work
PC18. dispose scrap or waste material into the
...
50 30 0 20 100 10
engineering drawing
ASC/N3617.Support the
technician in vehicle assembly 30 50 0 20 100 75
operations
Total 150 140 0 0 350 100
