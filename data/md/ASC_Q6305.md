# Qualification Pack: Automotive Quality Control Lead Inspector
**QP Code**: `ASC/Q6305`  
...
Qualification Pack
Automotive Quality Control Lead
Inspector
QP Code: ASC/Q6305
Version: 3.0
NSQF Level: 4.5
...
OR
Experience
B.E./B.Tech (1st year Pursuing)
OR
Certificate-NSQF (Electric Vehicle Quality Control
Inspector Level 3.5) with 3 Years of experience with
minimum education as 8th class pass
...
studies for all the measuring equipment to analyze the variation in measurement of
equipment
...
bore/air/ dial, slip gauges, etc., machine/fixture parameters in situ and mounted condition
...
precision etc.
KU3. Standard Operating Procedures (SOP) recommended by OEM for using testing equipment,
...
KU10. APQP (Advanced Product Quality Planning) and PPAP (Production Part Approval Process) for
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
Perform calibration of measuring and testing
12 19 - 8
equipment
PC1. receive the measuring and testing equipment
from vendors safely and ensure that they are 1 1 - -
validated and calibrated
PC2. prepare plan for the calibration, verification
and validation of all the testing and measuring 2 3 - 1
equipment as per the drawing and standards
PC3. select standard instruments to be used for
measurement based on the range, precision levels 1 2 - 1
and any limitations of profile of the equipment parts
PC4. conduct Measurement Systems Analysis (MSA)
and Repeatability and Reproducibility (R&R) studies
3 5 - 2
for all the measuring equipment to analyze the
variation in measurement of equipment
PC5. inspect the details of dimensions, marking,
material etc. as per the drawing by using higher 2 3 - 2
accuracy methods for the specified range
PC6. review MSA and R&R readings, inspection
reports and discard/ repair the measuring
2 3 - 1
equipment which does not adhere to the required
specification
PC7. discuss with the team and ensure that the
countermeasures for equipment having R&R outside 1 2 - 1
the acceptable range are implemented
Perform audit of product and process 7 11 - 3
PC8. prepare annual plan for process and product
2 2 - 1
audit and execute it on time
PC9. use appropriate validation techniques for audit
2 4 - 1
of the regular and new parts and processes
PC10. resolve non-conformities identified in
validation by discussion with manufacturing process
2 3 - 1
owners and then correct or re-verify/re-validate the
parts and processes
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC11. report to the senior management about
issues and seek support/feedback from them as per 1 2 - -
the requirements
Layout inspection by conventional method or 3D
11 20 - 9
CMM(Coordinate Measuring Machine)
PC12. select appropriate first principle method for
...
slip gauges, etc., machine/fixture parameters in situ
and mounted condition
PC13. conduct layout inspection of parts and
2 3 - 1
processes as per the WI/SOP
PC14. observe, analyze and co-relate the inspection
2 3 - 2
results/defects with part results
PC15. coordinate with the process owners for
discussing the counter measures for rectification of 1 2 - 1
defects and re-inspection
PC16. coordinate with NPD department and prepare
the schedule for gauge verification/validation based 2 3 - 1
on the requirements of the gauge
PC17. inspect and validate the gauges/jigs as per
the drawing and confirms that fit and tolerance, 1 4 - 1
function usage are within the specified range or not
PC18. maintain and update the records of
1 2 - 1
inspection and validation process done as per SOP
#### NOS Total 30 50 - 20
...
maintain the quality of parts 30 50 - 20 100 75
and processes
