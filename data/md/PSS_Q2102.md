...
- KU3. importance of working in a clean and safe environment, and practices and procedures to ensure the same
...
- KU5. structure of a power distribution system with respect to voltage level and network configuration (ring main/redial etc.) in the substation
...
- GS9. apply domain information to set and define operation parameters that ensures economy and quality of the product
...
transformer, switchgear, overhead lines, insulators and other related equipment for identification of faults, possible wear and tear
