# Qualification Pack: Electric Vehicle Test Engineer
**QP Code**: `ASC/Q8406`  
...
the testing tasks and type of tests required to be conducted on the component or on the
vehicle
...
testing gauges, strain gauges, displacement transducers, accelerometers, GPS data
collection devices and data loggers to capture the data points
...
cooling water level, tyre pressure, etc. before starting the on road testing of the vehicle
prototype as per the checklist and testing manual
...
KU6. Standard Operating Procedures (SOP) recommended by OEM for using testing equipment,
tools, gauges and measuring instruments
KU7. symbols, units and terms used in wiring diagrams associated with electrical/electric
...
KU9. typical symptoms of common faults and failures in vehicle's mechanical, electrical and
electronic systems
...
KU14. electrical and electronic testing equipment: volt meters, AM meters, OHM meters, battery
testing equipment, dedicated and computer based diagnostic equipment, oscilloscopes,
...
Marks Marks Marks Marks
Prepare for testing process 5 6 - 5
PC1. interpret the vehicle drawings, testing sheet
and coordinate with the superior for confirming the
1 1 - 1
testing tasks and type of tests required to be
conducted on the component or on the vehicle
PC2. identify, select and arrange the testing
equipment, measuring instruments, gauges, parts 1 1 - 1
etc. required during the testing process
PC3. check the tools, gauges and testing appratus
1 2 - 2
for defects and calibration status before use
PC4. identify the testing parameters which need to
2 2 - 1
be measured during the test procedure
Perform inspection and repairing of vehicle and its
8 16 - 6
components
PC5. follow safety practices recommended by
2 1 - 1
organisation during inspection and testing process
PC6. conduct test drive to assess the need for
repairs, calibration or any other adjustments in the
- 2 - -
electrical and mechanical components of the
vehicle
PC7. dismantle and reassemble aggregates of the
1 2 - 1
vehicle for fault diagnosis
PC8. conduct visual inspection of the bundled
wiring, circuits, Integrated Circuits (IC's), Printed
2 3 - 1
Circuit Boards (PCB's), wiring harnesses etc. for
wear and tear, damage etc.
PC9. check the connections of the instruments like
sensors, actuators, instrument clusters, ECU, 1 3 - 1
motors and other electronic circuits
PC10. calibrate, align and adjust the settings of
vehicle components as per the SOP and 1 3 - 1
organisational standards
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC11. ensure part clearances as specified in the
Work Instructions (WI)/Standard Operating 1 2 - 1
Processes (SOP)
Test vehicle and its components for faults in
13 23 - 6
laboratory
PC12. set the test apparatus as per the selected
2 6 - 1
testing process and SOPs/WI
PC13. connect the various data capturing meters
and gauges such as load cells, pneumatic/PLC
testing gauges, strain gauges, displacement 1 2 - 1
transducers, accelerometers, GPS data collection
devices and data loggers to capture the data points
PC14. diagnose faults in the various sensors,
actuators, power supply lines, electronic circuits
2 3 - -
and aggregates etc. in a vehicle by following
senior's instructions
PC15. conduct various tests as per Automotive
Industry Standard (AIS) 38, 39, 40, 41, 48, 49 and
2 3 - 1
short circuit/open circuit test under the supervision
of the Electric Vehicle test supervisor
PC16. record observations/ readings as per the
2 2 - 1
parameters mentioned in the testing manual/WI
PC17. make minor modification in test setup/
vehicle/component under testing to take reading 2 3 - 1
under different scenarios as per the requirement
PC18. conduct battery tests like abuse, altitude,
1 2 - 1
electrochemical impedance spectroscopy (SoH)
PC19. observe any deviations, noise or vibrations
during the testing process and inform the Electric 1 1 - -
Vehicle test supervisor about the same
PC20. change or repair the vehicle components as
- 1 - -
per requirement
Conduct testing of vehicle under running condition 1 1 - 1
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC21. check motor and converter status, battery
charge health and status, oil/lubricant level, cooling
water level, tyre pressure, etc. before starting the - 1 - 1
on road testing of the vehicle prototype as per the
checklist and testing manual
PC22. check working of all the safety features and
system warning indicators showing system failures,
1 - - -
loose connections, malfunctioning, etc. of vehicle as
per the vehicle safety check list and testing manual
Perform post-testing activities 3 4 - 2
PC23. maintain and update the records of test
- 1 - -
results, data log etc. as per SOP
PC24. report the malfunctions/repairs in the vehicle
1 - - -
beyond own scope to the concerned person
PC25. clean and store the tools, equipment and
process auxiliaries as per organisational guidelines 1 1 - -
after completion of work
PC26. dispose scrap or waste material in
accordance with the company policies and - 1 - 1
environmental regulations
PC27. perform scheduled checks, calibration and
timely repairs for workshop tools, equipment and 1 1 - 1
workstations
#### NOS Total 30 50 - 20
