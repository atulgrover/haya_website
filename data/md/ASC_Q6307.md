# Qualification Pack: Electric Vehicle Quality Control Inspector
**QP Code**: `ASC/Q6307`  
...
| Electric Vehicle Quality Control Inspector QP Code: ASC/Q6307 Version: 3.0 NSQF Level: 3.5 |
| :--- |
| Automotive Skills Development Council || 153, GF, Okhla Industrial Area, Phase 3 New Delhi 110020 || email:neha@asdc.org.in |


Qualification Pack
Electric Vehicle Quality Control
Inspector
QP Code: ASC/Q6307
Version: 3.0
NSQF Level: 3.5
...
Qualification Pack
Contents
ASC/Q6307: Electric Vehicle Quality Control Inspector ........................................................................ 3
...
ASC/N6313: Inspect and maintain the electric vehicle (EV) parts and process quality and implement
...
Qualification Pack
ASC/Q6307: Electric Vehicle Quality Control Inspector
Brief Job Description
The individual is responsible for conducting inspection and maintaining quality of the manufactured
...
- 3. ASC/N6313: Inspect and maintain the electric vehicle (EV) parts and process quality and
...
| Minimum Educational Qualification & Experience | 8th grade pass with 2 years of NTC with 1 Year of experience OR 8th grade pass with 3 Years of experience of relevant experience OR 10th grade pass and pursuing continuous schooling OR 11th grade pass OR Certificate-NSQF (Automotive Quality Control Inspector Level 3) with 2 Years of experience |
| :--- | :---: |
...
| Version | 3.0 |
| Reference code on NQR | QG-3.5-AU-00538-2023-V1.1-ASDC |
| NQR Version | 1.1 |
...
11th grade pass
OR
Certificate-NSQF (Automotive Quality Control
Inspector Level 3) with 2 Years of experience
...
Qualification Pack
ASC/N6313: Inspect and maintain the electric vehicle (EV) parts and
process quality and implement corrective actions
Description
This NOS unit is about inspecting and maintaining the quality of the parts and processes involved in
manufacturing an electric vehicle (EV).
Scope
The scope covers the following :
...
inspection tasks and quality check criteria of parts and processes involved in manufacturing
of EV based on the defined standards
...
PC5. conduct the visual inspection of EV parts or products for any scratches, dents, damages,
packing etc. as per the norms and quality standards
PC6. conduct the dimensional and functional check of EV parts or products by using inspection
and measuring instrument and gauges such as vernier caliper, bore gauge, Go/NOGO gauge,
micrometer etc.
PC7. verify the daily check items for e.g. battery functioning, fixture condition etc.
PC8. check the part or product through a reference for feel, touch, sound, smell, etc. if the
measurement is not possible
PC9. maintain and preserve the tested samples to track the inspection history of tested EV parts
or products and use it as defect/limit samples
PC10. ensure that the sticker/number/label is placed on the inspected automotive part or product
PC11. conduct inspection of EV manufacturing related processes to verify the process control items
by using pressure gauge, temperature gauge, voltmeter/ ammeter etc.
PC12. use Statistical Process Control (SPC) to measure and control the quality during the EV
...
Qualification Pack
PC13. prepare first-off inspection report by referring to process inspection standard/process
parameter sheet/control plan
PC14. record the observations of the inspection and update the reports such as inspection report,
charts in graphical pattern and other documents, manually or electronically as per the SOP
PC15. raise a scrap note and ensure that scrapped part or product is disposed-off as per the
organisational specified procedure
Co-ordinate with the team, and line incharge/supervisor
To be competent, the user/individual on the job must be able to:
PC16. coordinate with Cross Functional Team (CFT) for solving issues and corrective actions
pertaining to the EV products handled
PC17. collect data related to the problems identified during inspection process, analyse it with the
team and identify the corrective actions for clearing the discrepancies
PC18. coordinate with the respective process line leader/supervisor and give suggestions to seniors
for appropriate action based on findings of the inspection report of EV manufacturing process
PC19. implement corrective action for discrepancies identified in the inspection report
PC20. coordinate with the team and identify opportunities for improvements in productivity,
quality, cost, safety and morale in the manufacturing of EV
Knowledge and Understanding (KU)
The individual on the job needs to know and understand:
...
machines and devices used in electric vehicles such as: generator, AC and DC converters, AC
motor, DC motor, charging systems etc.)
...
KU7. symbols, units and terms used in wiring diagrams associated with electrical/electric systems/
components of the vehicle
KU8. legal regulations that need to be taken into account for handling electric vehicles in the
workshop
KU9. classification of measuring instruments such as direct/indirect, precision/non-precision etc.
KU10. Standard Operating Procedures (SOP) recommended by OEM for using testing equipment,
gauges and measuring instruments such as vernier, Micrometers, height gauge, surface
plate, etc.
KU11. QMS system guidelines followed in the organization such as IATF-16949
NSQC Approved || Automotive Skills Development Council 20

### Page 21

Qualification Pack
KU12. how to check the calibration of measuring instruments, gauges etc.
KU13. manufacturing process being followed for each product
KU14. inspection checkpoints for the parts, product and process
KU15. documentation required regarding quality inspection process
KU16. basic operation of software such as SAP, ERP etc.
KU17. use of appropriate PPE, material handling equipment and tools for completing the inspection
tasks
KU18. problem solving & analysis tools like 8Ds, five why analysis etc.
KU19. Root Cause Analysis (RCA) techniques
Generic Skills (GS)
User/individual on the job needs to know how to:
...
| Assessment Criteria for Outcomes | Theory Marks | Practical Marks | Project Marks | Viva Marks |
| :--- | :---: | :---: | :---: | :---: |
| Preparing for inspection process | 7 | 8 | - | 4 |
| PC1. interpret the inspection check sheet and coordinate with the superior for confirming inspection tasks and quality check criteria of parts and processes involved in manufacturing of EV based on the defined standards | 2 | 2 | - | 2 |
| PC2. identify and arrange testing equipment, measuring instruments, gauges, parts etc. required during the quality inspection process | 3 | 2 | - | 1 |
| PC3. ensure that tools, gauges and measuring instruments to be used for inspection process are calibrated | 2 | 4 | - | 1 |
| Perform inspection process | 18 | 32 | - | 13 |
| PC4. follow safety practices recommended by organisation during quality inspection process | - | 4 | - | 2 |
| PC5. conduct the visual inspection of EV parts or products for any scratches, dents, damages, packing etc. as per the norms and quality standards | - | 4 | - | 1 |
| PC6. conduct the dimensional and functional check of EV parts or products by using inspection and measuring instrument and gauges such as vernier caliper, bore gauge, Go/NOGO gauge, micrometer etc. | - | 2 | - | 1 |
| PC7. verify the daily check items for e.g. battery functioning, fixture condition etc. | 4 | 2 | - | 2 |
| PC8. check the part or product through a reference for feel, touch, sound, smell, etc. if the measurement is not possible | - | 2 | - | 2 |
| PC9. maintain and preserve the tested samples to track the inspection history of tested EV parts or products and use it as defect/limit samples | 2 | 2 | - | 2 |
| PC10. ensure that the sticker/number/label is placed on the inspected automotive part or product | - | 2 | - | - |
...
Marks Marks Marks Marks
Preparing for inspection process 7 8 - 4
PC1. interpret the inspection check sheet and
coordinate with the superior for confirming
inspection tasks and quality check criteria of parts 2 2 - 2
and processes involved in manufacturing of EV
based on the defined standards
PC2. identify and arrange testing equipment,
measuring instruments, gauges, parts etc. required 3 2 - 1
during the quality inspection process
PC3. ensure that tools, gauges and measuring
instruments to be used for inspection process are 2 4 - 1
calibrated
Perform inspection process 18 32 - 13
PC4. follow safety practices recommended by
- 4 - 2
organisation during quality inspection process
PC5. conduct the visual inspection of EV parts or
products for any scratches, dents, damages, - 4 - 1
packing etc. as per the norms and quality standards
PC6. conduct the dimensional and functional check
of EV parts or products by using inspection and
measuring instrument and gauges such as vernier - 2 - 1
caliper, bore gauge, Go/NOGO gauge, micrometer
etc.
PC7. verify the daily check items for e.g. battery
4 2 - 2
functioning, fixture condition etc.
PC8. check the part or product through a reference
for feel, touch, sound, smell, etc. if the - 2 - 2
measurement is not possible
PC9. maintain and preserve the tested samples to
track the inspection history of tested EV parts or 2 2 - 2
products and use it as defect/limit samples
PC10. ensure that the sticker/number/label is placed
- 2 - -
on the inspected automotive part or product
...
| Assessment Criteria for Outcomes | Theory Marks | Practical Marks | Project Marks | Viva Marks |
| :--- | :---: | :---: | :---: | :---: |
| PC11. conduct inspection of EV manufacturing related processes to verify the process control items by using pressure gauge, temperature gauge, voltmeter/ ammeter etc. | - | 4 | - | 1 |
| PC12. use Statistical Process Control (SPC) to measure and control the quality during the EV manufacturing process | 2 | 2 | - | - |
| PC13. prepare first-off inspection report by referring to process inspection standard/process parameter sheet/control plan | 2 | 2 | - | - |
| PC14. record the observations of the inspection and update the reports such as inspection report, charts in graphical pattern and other documents, manually or electronically as per the SOP | 4 | 4 | - | 2 |
| PC15. raise a scrap note and ensure that scrapped part or product is disposed-off as per the organisational specified procedure | 4 | 2 | - | - |
| Co-ordinate with the team, and line incharge/supervisor | 5 | 10 | - | 3 |
| PC16. coordinate with Cross Functional Team (CFT) for solving issues and corrective actions pertaining to the EV products handled | 1 | 2 | - | 1 |
| PC17. collect data related to the problems identified during inspection process, analyse it with the team and identify the corrective actions for clearing the discrepancies | 2 | 2 | - | - |
| PC18. coordinate with the respective process line leader/supervisor and give suggestions to seniors for appropriate action based on findings of the inspection report of EV manufacturing process | - | 2 | - | - |
| PC19. implement corrective action for discrepancies identified in the inspection report | 1 | 2 | - | 1 |
| PC20. coordinate with the team and identify opportunities for improvements in productivity, quality, cost, safety and morale in the manufacturing of EV | 1 | 2 | - | 1 |
| NOS Total | 30 | 50 | - | 20 |
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC11. conduct inspection of EV manufacturing
related processes to verify the process control items
- 4 - 1
by using pressure gauge, temperature gauge,
voltmeter/ ammeter etc.
PC12. use Statistical Process Control (SPC) to
measure and control the quality during the EV 2 2 - -
manufacturing process
PC13. prepare first-off inspection report by referring
to process inspection standard/process parameter 2 2 - -
sheet/control plan
PC14. record the observations of the inspection and
update the reports such as inspection report, charts
4 4 - 2
in graphical pattern and other documents, manually
or electronically as per the SOP
PC15. raise a scrap note and ensure that scrapped
part or product is disposed-off as per the 4 2 - -
organisational specified procedure
Co-ordinate with the team, and line
5 10 - 3
incharge/supervisor
PC16. coordinate with Cross Functional Team (CFT)
for solving issues and corrective actions pertaining 1 2 - 1
to the EV products handled
PC17. collect data related to the problems identified
during inspection process, analyse it with the team
2 2 - -
and identify the corrective actions for clearing the
discrepancies
PC18. coordinate with the respective process line
leader/supervisor and give suggestions to seniors
- 2 - -
for appropriate action based on findings of the
inspection report of EV manufacturing process
PC19. implement corrective action for discrepancies
1 2 - 1
identified in the inspection report
PC20. coordinate with the team and identify
opportunities for improvements in productivity,
1 2 - 1
quality, cost, safety and morale in the
manufacturing of EV
#### NOS Total 30 50 - 20
...
| NOS Code | ASC/N6313 |
| :--- | :---: |
| NOS Name | Inspect and maintain the electric vehicle (EV) parts and process quality and implement corrective actions |
| Sector | Automotive |
| Sub-Sector | Manufacturing |
| Occupation | Automotive Quality Assurance |
| NSQF Level | 3.5 |
...
National Occupational Standards (NOS) Parameters
#### NOS Code ASC/N6313
Inspect and maintain the electric vehicle (EV) parts and process quality
#### NOS Name
...
| ASC/N6313.Inspect and maintain the electric vehicle (EV) parts and process quality and implement corrective actions | 30 | 50 | - | 20 | 100 | 75 |
...
20 30 - - 50 10
Skills (60 Hours)
ASC/N6313.Inspect and
maintain the electric vehicle
(EV) parts and process quality 30 50 - 20 100 75
