# Qualification Pack: Data Scientist
**QP Code**: `SSC/Q8104`  
...
Credits 21
Aligned to NCO/ISCO/ISIC Code NCO-2015/NIL
Completed 4 year UG program (** PHD or PG or UG or
...
Quality,Conduct Regular Data Audits and Performance Reviews,Establish Feedback Loops and
Continuous Improvement Processes,Promote Cross-functional Collaboration and Training,Maintain
...
30 50 - 20
PC1. Determine clear criteria for data quality
dimensions (accuracy, completeness, consistency,
3 5 - 2
timeliness, validity, relevancy) and acceptable
benchmarks, tailored to organizational needs
PC2. Create and implement processes, automated
scripts, validation rules, and controls to regularly 3 5 - 2
assess data against the defined standards.
PC3. Define data structures aligning with
organizational databases, and encode rules to
3 5 - 2
validate incoming data to ensure it meets quality
criteria before entry.
PC4. Transfer validated data into data warehouses
or databases, ensuring seamless merging with
3 5 - 2
existing datasets, and employ real-time solutions
where applicable
PC5. Use tools to automate monitoring, generate
alerts, and visualize data quality metrics in real 3 5 - 2
time for quick detection and response to issues
PC6. Schedule and perform audits to validate data
compliance, analyze discrepancies, and perform 3 5 - 2
gap analysis to identify areas for improvement
PC7. Gather insights from audits, monitoring, and
end-users to refine standards, processes, and 3 5 - 2
controls continually
PC8. Work closely with IT, data science, and
business teams to align efforts and develop
3 5 - 2
training programs to foster a culture of data
quality
PC9. Keep detailed records of data quality
standards, procedures, incidents, and
3 5 - 2
improvement actions for transparency and audit
readiness
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC10. Encourage a proactive approach toward
continuous improvement, leveraging new
3 5 - 2
technologies, and fostering staff awareness of data
quality principles
#### NOS Total 30 50 - 20
...
3 4 - 2
processes
PC8. Repeat the analysis iteratively to arrive
2 3 - 1
at optimal results
...
Marks Marks Marks Marks
30 50 - 20
PC1. Identify and clearly define the analysis
2 2 - 1
objectives based on business needs
PC2. Develop hypotheses and select appropriate
libraries, frameworks, and tools to address the 2 2 - 1
objectives.
PC3. Conduct research on existing statistical and
2 3 - 1
machine learning models for suitability
PC4. Choose the mode of learning (supervised,
unsupervised, reinforcement) based on data and 2 4 - 1
objectives
PC5. Prototype and develop the algorithmic
2 4 - 2
models aligned with project requirements
PC6. Validate models using proper testing
techniques, ensuring accuracy, robustness, and 2 4 - 2
fairness.
PC7. Optimize models through hyperparameter
3 5 - 2
tuning and iterative improvements
PC8. Address issues like overfitting, underfitting,
3 5 - 2
residual errors, and dispersion errors.
PC9. Document model design, assumptions, and
3 5 - 2
versioning for future reference
PC10. Set success metrics for model
performance and evaluate models against these 3 5 - 2
metrics
PC11. Establish data flows and manage data
3 6 - 2
inputs needed for model training and testing
PC12. Implement continuous retraining where
3 5 - 2
applicable to maintain model relevance
#### NOS Total 30 50 - 20
...
KU8. different methodological approaches for identifying model hyperparameters such as grid
...
Marks Marks Marks Marks
30 50 - 20
PC1. Define the objectives, expected
3 6 - 2
outcomes, and applicable performance metrics
PC2. Identify data sources, assumptions, and
3 6 - 2
potential biases in model design
PC3. Test models across different
inputs/scenarios to understand variability and 3 6 - 2
risks
PC4. Quantify potential risks such as
3 6 - 2
unexpected outcomes, bias, or model failures
PC5. Develop mitigation strategies, checks,
3 6 - 2
and validation processes to minimize risks
PC6. Document risk assessments, mitigation
7 7 - 4
measures, and validation outcomes
PC7. Engage stakeholders to validate risk
5 7 - 4
management plans
PC8. Implement corrective actions and
3 6 - 2
iteratively improve risk controls
#### NOS Total 30 50 - 20
...
such as excel sheets, reports, APIs to report 4 6 - 3
...
PC6. Present outcomes through selected
visualizations using standard templates and 4 6 - 2
...
SSC/N8157.Collect & process
data and ensure data quality 30 50 0 20 100 18
standards are achieved
SSC/N8103.Perform exploratory
and Inferential analysis of the 30 50 0 20 100 18
data
SSC/N8104.Perform research,
design & validation of 30 50 0 20 100 18
algorithmic models
SSC/N8106.Risk Analysis &
Mitigation for Algorithmic 30 50 0 20 100 18
Models
