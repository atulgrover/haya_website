...
the use of, optical and laser 3D scanners, graphic work stations, additive machines, other machines, and post-processing equipment
...
Possible or impossible to perform, The accuracy it is possible to attain for the object, The required conditions for digitizing
...
polygonal models (for example, the gear wheel has only one preserved tooth, the worm has only one turn, or there is only one-third of the flange), Taken from connected parts, Taken
...
requirements, binding elements, postprocessing allowances, stresses relieve operations sequence)
