...
ratio, chemicals, auxiliaries, etc.) for the received quantity of yarn in reference to given recipe
...
- KU10. quality requirement of water and the chemicals to be used for various pre-dyeing, dyeing and finishing activities
...
- GS1. write clear and short sentences in the record book (i.e.,recipe, process flow, weight of received materials, etc.)
...
- GS6. carry out basic arithmetic calculation involved in money transactions, income/ expense values, etc.
