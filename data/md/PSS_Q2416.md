# Qualification Pack: Smart Grid Technician
**QP Code**: `PSS/Q2416`  
...
Electrical/Electronics/Instrumentation Engineering OR)
...
by interpreting manufacturer manual, maintenance checklist and schedule, work
instructions, etc
...
KU8. How to analyse evidence and evaluate possible characteristics and causes of specific
faults/problems
...
KU12. Relevant precautions to be taken to prevent Electrostatic Discharge (ESD) damage to
electronic circuits and components
KU13. Working purpose of individual units/components and how they interact
KU14. Importance of ensuring the control systems is isolated or put into manual control, and
appropriate trip locks
KU15. How to carry out visual checks of the smart grid systems including checking for leaks,
...
KU17. Relevant techniques used to dismantle/assemble integrated equipment i.e. release of
...
KU18. Importance and process of attaching identification marks/labels to removed components or
cables, to assist with reassembly
KU19. Applicable methods for checking components are fit for purpose, and the need to replace
...
KU21. How to resolve the common problems encountered during the maintenance of the smart grid
systems
KU22. The importance of making process improvements by engaging the relevant stakeholders
KU23. Process of carrying out different types of maintenance such as preventive, corrective,
...
requirements of various components and control
system by interpreting manufacturer manual, 1 1 - -
maintenance checklist and schedule, work
instructions, etc
PC2. Read maintenance schedule and checklist and
plan the time and schedule for conducting the 1 1 - -
maintenance activities
PC3. Identify various systems, sub systems and
2 2 - -
control systems of the smart grid
PC4. Arrange tools, consumables, spare parts, etc.
1 1 - -
required for performing repair and maintenance
PC5. Clear the work area thoroughly to ensure no
unwanted materials are present before starting the 1 1 - -
work
PC6. Ensure that devices, machines etc. in the
smart grid are not connected to any power source - 1 - -
before starting maintenance work
PC7. Adhere to all safety norms (such as wearing
protective gloves and shoes, etc.) in accordance
- 1 - -
with the international/ national and organisational
standards
PC8. Inform all affected parties of the intended work
1 1 - -
plan prior to disconnecting power supply line
Perform maintenance activities 18 26 - -
PC9. Perform basic health check-up of instruments,
sensors, controllers etc. as specified in the 2 3 - -
manufacturer manual
PC10. Start and shut down process of smart grid to
observe the functioning of power plant and its
2 3 - -
...
parameters
PC12. Inspect power stations, transmission lines,
distribution lines, automated systems and other
2 4 - -
critical equipment for identification of faults,
possible wear and tear etc.
PC13. Locate the protection devices i.e. relay,
breaker etc., conduit, cables & other underground 1 1 - -
system to perform maintenance work
PC14. Carry out the maintenance activities by
2 3 - -
following appropriate techniques and procedures
PC15. Monitor running parameter of smart grid and
1 2 - -
auxiliaries’ system as per design standard
PC16. Test the system parameters to know
abnormal condition of the system and healthiness 2 3 - -
of connected equipment
PC17. Check the problem and keep the superiors
informed about progress or any delays in resolving 1 1 - -
the problem
PC18. Upgrade or modify the existing unhealthy
equipment/system after confirmation from 1 1 - -
supervisor/engineer
PC19. Suggest technical changes in
1 1 - -
equipment/system to supervisor/engineer
PC20. Suggest software upgradation and testing
1 1 - -
required to supervisor/engineer
Troubleshooting and repairing of faulty equipment 11 20 - -
PC21. Carry out troubleshooting of faulty or
unhealthy equipment to determine root causes and 2 3 - -
develop processes to avoid repeat failure
PC22. Identify the type of faults, required tools and
1 2 - -
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC23. Conduct breakdown maintenance and then
...
PC24. Isolate the faulty part and replace/repair it by
following correct procedures and manufacturer 1 2 - -
specification
PC25. Clean and tighten the terminals, screws,
clamps and cables and ensure that they are free
1 2 - -
from dirt, grime and corrosion by following the
instructions given in manufacturer manual
PC26. Conduct the appropriate tests related to the
1 2 - -
functional performance of equipment, as required
PC27. Coordinate with engineers and process
technicians to resolve the issues requiring their 1 2 - -
assistance
PC28. Coordinate with the relevant personnel to
1 2 - -
evaluate the functioning of smart grid
PC29. Assess when the problem is beyond his
...
environmental policies
PC32. Record all repairs carried out, time taken and
other significant findings observed during the work 1 2 - -
process
...
Sector Power
Sub-Sector Distribution
Operation and Maintenance - Distribution, Erection, Installation and
Occupation
Commissioning - Distribution Downstream
NSQF Level 4
Credits 4
Version 1.0
Last Reviewed Date 22/10/2024
...
KU5. Relevant terms, signs, symbols and other graphical representations and their respective
interpretations
KU6. CEA regulations for smart grid operations
KU7. Common power plant terminology e.g. temperature, pressure, ph, current, voltage,
resistance, kilowatt (kw), kilowatt hour, plf
KU8. Layout and schematic of smart grid including machine arrangement, equipment layout,
switchyard, auxiliary arrangements
KU9. Various smart grid components and sections i.e. power stations, transmission lines,
...
Marks Marks Marks Marks
Perform operation of smart grid 30 70 - -
PC1. Follow safe working practices in accordance
1 2 - -
with the organizational standards and regulations
PC2. Obtain instructions from the
1 2 - -
supervisor/engineer related to day’s work
PC3. Use specialized equipment, software, and
protocols to ensure the safe and stable operation
4 7 - -
of power systems, as well as responding to
emergencies and disturbances
PC4. Check the smart grid components for any
2 5 - -
faults or abnormalities
PC5. Ensure smooth operation of power stations,
2 5 - -
transmission lines, and distribution lines
PC6. Monitor load, grid stability, frequency, load
2 5 - -
dispatch, feeder loading etc.
PC7. Monitor and control the status and
parameters of smart grid components, such as 3 7 - -
voltage, frequency, power flow, and demand.
PC8. Operate and switch smart grid devices 3 7 - -
PC9. Operate and monitor critical system such as
SAS, RTU, Remote Monitoring Unit (RMU) and 3 8 - -
other automation system installed in the grid
PC10. Coordinate and communicate with other
operators, engineers, distributors, and customers 2 5 - -
in smart grid operation
PC11. Implement and follow operating procedures
2 5 - -
for smart grid operation
PC12. Identify and report system faults, events,
2 5 - -
and anomalies
PC13. Restore and maintain power system service
1 2 - -
in case of outages or contingencies
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC14. Suggest technical changes in
2 5 - -
equipment/system to supervisor/engineer
#### NOS Total 30 70 - -
...
PSS/N2409.Carry Out
40 60 - - 100 35
Maintenance Of Smart Grid
PSS/N1720.Perform Operation
30 70 - - 100 35
Of Smart Grid
