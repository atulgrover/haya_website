# Qualification Pack: Advance Pattern Maker(CAD/CAM)
**QP Code**: `AMH/Q1101`  
...
Description
This unit is about how the advance pattern maker manages to develop the patterns using CAD/CAM
software
Scope
...
Prepare the prerequisites for CAD/CAM operation 3 12 - 3
PC1. Download and organize information
1 5 - 1
obtained by designer/buyer
PC2. Analyze specific information and translating
1 6 - 1
according to company procedure
PC3. Coordinate with merchandiser to ensure
clarity of information and resolve any possible 1 1 - 1
misinterpretations
Operate the CAD/CAM 33 114 - 15
PC4. Draft the pattern or digitize the manual
pattern on the CAD software as per specification 6 30 - 3
given
PC5. Adjust the pattern specifications as per the
4 9 - 1
standard and allowances required
PC6. Incorporate shrinkage and perform size
wise grading of patterns as provided in the BOM 8 23 - 3
(bill of material)
PC7. Determine the cut ratio plan 4 9 - 2
PC8. Perform the most efficient marker (lay
planning) according to the configuration 3 12 - 1
intended
PC9. Set parameters on CAM as per required
1 10 - 1
output
PC10. Ensure the design output is cut and hand
1 5 - 1
over to the next department
PC11. Ensure the work is saved as a back-up
2 4 - 1
before shutting down the CAD machine
PC12. Take printout of mini marker to be handed
2 6 - 1
over to the merchandiser, for reference
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC13. Shut down, after every use, the CAD/CAM
system carefully and in accordance with 2 6 - 1
...
clean and hazard free working area and support adaptation to more environmentally friendly
processes
...
GS20. Make conscious and sustainable decisions that help reduce, rescue, and recycle the
company resources
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
To maintain the work area, tools and machines and
16 56 - 8
observe greening of job functions.
PC1. Handle materials, equipment, computer and
software safely and correctly to maintain a clean
and hazard free working area and support 1 5 - 0.5
adaptation to more environmentally friendly
processes
PC2. Use correct handling procedures and
maintain tools and equipment; and inculcate
2 10 - 1
sustainable consumption practices and offer
relevant greening solutions
PC3. Work in comfortable position and maintain
2 10 - 1
correct posture
PC4. Deal with work interruptions effectively 1 1 - 0.5
PC5. Carry out running maintenance and/or
cleaning within one’s responsibility and agreed 3 15 - 0.5
schedules
...
PC8. Request for upgrading of system or
1 - - 0.5
software when required for effective working
PC9. Always maintain a backup file when working
2 5 - 1
on various design software
...
AMH/N1101.Pattern
36 126 - 18 180 52
development through CAD/CAM
AMH/N1102.Maintenance of
work area, machinery, tools and 16 56 - 8 80 23
equipment.
