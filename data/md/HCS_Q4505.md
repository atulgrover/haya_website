# Qualification Pack: Lacquerer (Paper Mache)
**QP Code**: `HCS/Q4505`  
...
KU11. methods to make use of the information detailed in specification sheets and work
instructions
Generic Skills (GS)
...
PC3. select suitable lacquer based on hue and
- 2 - -
tone of object and customer requirement
PC4. transfer lacquer (varnish) in a clean bowl - 2 - -
PC5. dilute with volatile thinner to make
- 2 - -
solution of suitable consistency
PC6. mix the lacquer and thinner well with a
- 2 - -
stirrer
PC7. check the mixture by sample testing on
suitable materials to ensure it matches with - 2 - -
the shade/finish required
Applying lacquer on object 2 13 - -
PC8. ensure the object is clean, smooth and
- 2 - -
free from dust, dirt etc.
PC9. ensure the object is not damp or wet - 1 - -
PC10. apply lacquer to the object uniformly as
- 3 - -
per finish required
PC11. allow it to dry - 2 - -
PC12. check the coating and if needed apply
1 3 - -
second coat and allow to dry
PC13. continue applying lacquer and drying till
1 2 - -
desired level of shine/finish is attained
#### NOS Total 3 30 - -
