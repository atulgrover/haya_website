# Qualification Pack: Automotive Machining Assistant
**QP Code**: `ASC/Q3502`  
...
| Automotive Machining Assistant QP Code: ASC/Q3502 Version: 5.0 NSQF Level: 2 |
| :--- |
| Automotive || 153, GF, Okhla Industrial Area, Phase 3 New Delhi 110020 || email:garima@asdc.org.in |


Qualification Pack
Automotive Machining Assistant
QP Code: ASC/Q3502
Version: 5.0
NSQF Level: 2
...
Qualification Pack
Contents
ASC/Q3502: Automotive Machining Assistant ...................................................................................... 3
...
ASC/N3501: Support the machining operator in the routine machining activities ............................. 17
...
| NSQF Level | 2 |
| Credits | 10 |
| Aligned to NCO/ISCO/ISIC Code | NCO-2015/9321.1401 |
...
Qualification Pack
ASC/Q3502: Automotive Machining Assistant
Brief Job Description
The individual in this role supports the machining operator during preparation of machining work such as
bringing raw material and tools, machining activities such as machine setup, aligning workpiece, holding
tools etc. and cleaning and maintenance of machine and work area.
Personal Attributes
...
- 3. ASC/N3501: Support the machining operator in the routine machining activities
...
| Version | 5.0 |
| Reference code on NQR | 2022/AUT/ASDC/06558 |
| NQR Version | 5 |
...
Qualification Pack
ASC/N3501: Support the machining operator in the routine machining
activities
Description
This NOS is about supporting machining operator during preparation for machining work, machining
activities and post machining activities.
Scope
The scope covers the following :
Support machine operator in pre-machining operations
Support machine operator in machining operations
Support machine operator in post-machining operations
Perform cleaning of machine and workplace
Elements and Performance Criteria
Support machine operator in pre-machining operations
To be competent, the user/individual on the job must be able to:
PC1. identify the tools, measuring instruments and input materials required for the job
PC2. collect the required toolkits and material from the stores and ensure that all the items
required for production and inspection are available as per SOP
PC3. check the tools and input material for any defects and that they are as per the required
quality standards
PC4. support the machine operator in setting of the tools, fixtures/jigs and cutting tools on the
machine as per the process requirement
Support machine operator in machining operations
To be competent, the user/individual on the job must be able to:
PC5. support the machine operator in fixing or clamping the work pieces on the machine in the
specified manner
PC6. ensure that there is no damage done to the work pieces and machine auxilliaries during
loading on the machine apparatus manually or using pulleys, chains and other hoisting
mechanisms
PC7. hold the tools during machining operations in the correct manner as specified by the
operator using appropriate PPE
Support machine operator in post-machining operations
To be competent, the user/individual on the job must be able to:
PC8. support the machine operator in removing the component from the machine and extracting
the jammed pieces using wire hooks, lift bars, hands etc.
PC9. support in segregating, tagging and storing the completed pieces into Ok pieces, defective
pieces which can be repaired/reworked and pieces which are beyond repair
PC10. put the pieces into right trolleys/ bins and move them to the designated area for next
process
...
Perform cleaning of machine and workplace
To be competent, the user/individual on the job must be able to:
PC11. clean and store the tools, equipment and process auxiliaries as per organisational guidelines
after completion of work
PC12. remove chips from different machine areas and clean the workarea properly
PC13. dispose scrap or waste material in accordance with the company policies and environmental
regulations
Knowledge and Understanding (KU)
The individual on the job needs to know and understand:
KU1. SOP recommended by the manufacturer for using tools, jigs, fixtures, measuring instruments
etc., during the machining processes
KU2. how to recognise machine parts and tools required during different machining operations
KU3. various types of machining processes such as drilling, boring, turning etc.
KU4. SOP recommended by the organisation for checking irregularities in the product/work piece
KU5. common terminologies used in machining work
KU6. safety requirements during the machining work
KU7. how to clean and store tools, machine and its auxiliaries
Generic Skills (GS)
User/individual on the job needs to know how to:
...
| Assessment Criteria for Outcomes | Theory Marks | Practical Marks | Project Marks | Viva Marks |
| :--- | :---: | :---: | :---: | :---: |
| Support machine operator in pre-machining operations | 9 | 14 | - | 9 |
| PC1. identify the tools, measuring instruments and input materials required for the job | 5 | 2 | - | 3 |
| PC2. collect the required toolkits and material from the stores and ensure that all the items required for production and inspection are available as per SOP | 1 | 3 | - | 2 |
| PC3. check the tools and input material for any defects and that they are as per the required quality standards | 1 | 5 | - | 2 |
| PC4. support the machine operator in setting of the tools, fixtures/jigs and cutting tools on the machine as per the process requirement | 2 | 4 | - | 2 |
| Support machine operator in machining operations | 3 | 14 | - | 4 |
| PC5. support the machine operator in fixing or clamping the work pieces on the machine in the specified manner | 1 | 5 | - | 2 |
| PC6. ensure that there is no damage done to the work pieces and machine auxilliaries during loading on the machine apparatus manually or using pulleys, chains and other hoisting mechanisms | 1 | 4 | - | - |
| PC7. hold the tools during machining operations in the correct manner as specified by the operator using appropriate PPE | 1 | 5 | - | 2 |
| Support machine operator in post-machining operations | 5 | 14 | - | 4 |
| PC8. support the machine operator in removing the component from the machine and extracting the jammed pieces using wire hooks, lift bars, hands etc. | 2 | 4 | - | 2 |
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
Support machine operator in pre-machining
9 14 - 9
operations
PC1. identify the tools, measuring instruments and
5 2 - 3
input materials required for the job
PC2. collect the required toolkits and material from
the stores and ensure that all the items required
1 3 - 2
for production and inspection are available as per
SOP
PC3. check the tools and input material for any
defects and that they are as per the required 1 5 - 2
quality standards
PC4. support the machine operator in setting of
the tools, fixtures/jigs and cutting tools on the 2 4 - 2
machine as per the process requirement
Support machine operator in machining operations 3 14 - 4
PC5. support the machine operator in fixing or
clamping the work pieces on the machine in the 1 5 - 2
specified manner
PC6. ensure that there is no damage done to the
work pieces and machine auxilliaries during
loading on the machine apparatus manually or 1 4 - -
using pulleys, chains and other hoisting
mechanisms
PC7. hold the tools during machining operations in
the correct manner as specified by the operator 1 5 - 2
using appropriate PPE
Support machine operator in post-machining
5 14 - 4
operations
PC8. support the machine operator in removing
the component from the machine and extracting
2 4 - 2
the jammed pieces using wire hooks, lift bars,
hands etc.
...
| Assessment Criteria for Outcomes | Theory Marks | Practical Marks | Project Marks | Viva Marks |
| :--- | :---: | :---: | :---: | :---: |
| PC9. support in segregating, tagging and storing the completed pieces into Ok pieces, defective pieces which can be repaired/reworked and pieces which are beyond repair | 2 | 5 | - | 1 |
| PC10. put the pieces into right trolleys/ bins and move them to the designated area for next process | 1 | 5 | - | 1 |
| Perform cleaning of machine and workplace | 3 | 18 | - | 3 |
| PC11. clean and store the tools, equipment and process auxiliaries as per organisational guidelines after completion of work | 1 | 6 | - | 1 |
| PC12. remove chips from different machine areas and clean the workarea properly | 1 | 6 | - | 1 |
| PC13. dispose scrap or waste material in accordance with the company policies and environmental regulations | 1 | 6 | - | 1 |
| NOS Total | 20 | 60 | - | 20 |
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC9. support in segregating, tagging and storing
the completed pieces into Ok pieces, defective
2 5 - 1
pieces which can be repaired/reworked and pieces
which are beyond repair
PC10. put the pieces into right trolleys/ bins and
move them to the designated area for next 1 5 - 1
process
Perform cleaning of machine and workplace 3 18 - 3
PC11. clean and store the tools, equipment and
process auxiliaries as per organisational guidelines 1 6 - 1
after completion of work
PC12. remove chips from different machine areas
1 6 - 1
and clean the workarea properly
PC13. dispose scrap or waste material in
accordance with the company policies and 1 6 - 1
...
| NOS Code | ASC/N3501 |
| :--- | :---: |
| NOS Name | Support the machining operator in the routine machining activities |
| Sector | Automotive |
| Sub-Sector | Manufacturing |
| Occupation | Machining Operation |
| NSQF Level | 2 |
...
| ASC/N3501.Support the machining operator in the routine machining activities | 20 | 60 | 0 | 20 | 100 | 75 |
...
20 30 0 0 50 10
Skills (30 Hours)
ASC/N3501.Support the
machining operator in the 20 60 0 20 100 75
routine machining activities
Total 90 120 0 0 250 100
