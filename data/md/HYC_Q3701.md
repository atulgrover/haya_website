...
time involved, resources available, number of stops/meters to service and geographic conditions of the work area
...
Procedure (SOP) and record the same with date in meter reading book or hand-held device or smart phone
...
such as regulator service, excess bill amount etc., and submit the same to reporting authority
...
- KU10. how to operate hand held device, its connection with gas meter, data download and upload the same in computer system for bill generation
...
- KU16. the usage of relevant applications in the smart mobile phone for capturing the meter readings and forwarding for billing process
...
- GS3. how to read and interpret the process required for various types of metering and billing operations
NSQC Approved || Hydrocarbon Sector Skill Council                    6

### Page 7

Qualification Pack
- GS4. how to read manuals and operation documents to understand the metering equipment used for operation
