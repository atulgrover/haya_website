...
Description
This NOS is about performing end to end welding operations to ensure that the final products manufactured is as per the quality, cost and production norms set by the organization
Scope
The scope covers the following :
...
Specification (WPS), job orders etc. and take inputs from the master welding technician for production planning
