# Qualification Pack: Automotive Machining Operator
**QP Code**: `ASC/Q3501`  
...
disposing scrap or waste material in accordance with the company policies and
...
Marks Marks Marks Marks
Identify work requirements 5 9 - 6
PC1. take inputs from the immediate supervisor
1 1 - 1
regarding production planning
PC2. identify the input and output product based on
1 2 - 1
engineering drawing and job orders
PC3. identify the tools, measuring instruments and
1 3 - 2
input materials required for the job
PC4. identify the tooling instructions for fixtures,
cutting tools, jigs, gauges etc. as specified in the
2 3 - 2
Operating Manual/Work Instructions (WI) or
Standard Operating Procedures (SOP)
Preparing for machining activities 8 14 - 6
PC5. support the machining technician in setting of
2 3 - 2
the machine and its parameters as per SOP
PC6. select appropriate coolant and lubricant
2 2 - 1
required for machining component as per SOP/WI
PC7. ensure that all the items required for
- 2 - -
production and inspection are available as per SOP
PC8. check the tools and equipments for any
2 4 - 2
defects before use
PC9. check the input material as per the control
2 3 - 1
plan/check sheet and the required quality standard
Support in machining operations 8 13 - 4
PC10. start the machine for machining operations 2 3 - 1
PC11. support in selecting the right CNC
programme in the CNC machine as defined in the 2 2 - 1
SOP
PC12. support in production process of component,
measure the final machine piece and compare with
3 6 - 2
the dimensions as prescribed in the work order and
engineering drawing
...
2 3 - -
WI for product quality
PC15. support in inspection process and check the
work pieces as per the work instructions for 2 3 - 1
product quality
PC16. support in segregating the completed pieces
in to Ok pieces, defective pieces which can be
2 2 - 1
repaired/reworked and pieces which are beyond
repair and maintain records of each category
PC17. check the machine operations for any
malfunctions/defects in the component and
2 3 - 1
immediately inform the supervisor/maintenance
team for correction
PC18. support in removing chips, burrs and sharp
edges from different machine areas and disposing
1 3 - 1
scrap or waste material in accordance with the
company policies and environmental regulations
#### NOS Total 30 50 - 20
...
50 30 0 20 100 10
engineering drawing
ASC/N3506.Support in
machining and post machining 30 50 0 20 100 75
activities
Total 150 140 0 0 350 100
