# Qualification Pack: Automotive Material Handling Operator
**QP Code**: `ASC/Q6103`  
...
Qualification Pack
Automotive Material Handling Operator
QP Code: ASC/Q6103
Version: 3.0
NSQF Level: 3
...
The individuals at this job need to pick and issue the different parts and assemblies from
Stores/warehouses according to production and shipping schedules.
Personal Attributes
...
10th grade pass
OR
9th grade pass with 1.5 years of experience Store/
Material Handling Operations
OR
Minimum Educational Qualification &
8th Class pass with 3 Years of experience Store/
Experience
Material Handling Operations
OR
Previous relevant Qualification of NSQF Level 2
(Automotive Material Handling Assistant) with 3
Years of experience
...
leaflets for usage, moisture restricting capsules, commercial papers, insurance documents
etc. are available in the packing box
PC6. check that shipping address and packing box indicators e.g. complete address with contact
details, orientation of box etc. are correctly marked on the box as per WI / customer
documentation
...
KU3. SOP recommended by the manufacturer for using material handling equipment such as
...
1 3 - 1
the tasks
PC2. check the pertaining documents of dispatch
schedule and BOM for product/s being 3 5 - 2
manufactured/shipped
PC3. select and pick the parts from the storage bin
of stores corresponding to the part no. mentioned 4 8 - 3
in BOM
PC4. ensure that the selected part is safely kept in
2 4 - 2
storage locations of stores
Issuing the parts to shop floor/dispatch 20 30 - 12
PC5. check that spare parts/vehicles/after market
dispatches specified papers and items e.g. leaflets
for usage, moisture restricting capsules, 2 3 - 1
commercial papers, insurance documents etc. are
available in the packing box
PC6. check that shipping address and packing box
indicators e.g. complete address with contact
details, orientation of box etc. are correctly 2 3 - 2
marked on the box as per WI / customer
documentation
PC7. select appropriate material handling
3 4 - 2
equipment to handle and lift the parts
PC8. issue the parts shop floor/dispatch by
3 6 - 2
following SOP and organisational guidelines
PC9. Identify and operate digital inventory systems
2 2 - 1
including barcode and RFID scanners.
PC10. Conduct pre-operational safety checks on
material handling equipment such as trolleys and 2 4 - 1
forklifts.
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC11. Demonstrate correct procedures for
scanning, locating, and issuing material using 2 3 - 1
digital tools.
PC12. Apply safety protocols and wear appropriate
2 3 - 1
PPE while handling and issuing parts from stores.
PC13. Complete basic documentation such as EHS
checklists and stock verification sheets as per 2 2 - 1
SOPs
#### NOS Total 30 50 - 20
...
ASC/N6103.Pick and issue the
30 50 - 20 100 75
parts from stores as per BOM
