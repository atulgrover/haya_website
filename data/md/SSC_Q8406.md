# Qualification Pack: Drone Software Technician
**QP Code**: `SSC/Q8406`  
...
- 2. SSC/N8436: Conduct thorough testing of drone system software in both simulated environments
and real-world scenarios to ensure reliability and safety
...
Qualification Pack
12th grade Pass (in STEM)
OR
10th grade pass (in STEM) with 1.5 years of experience in
relevant field.Relevant Experience in job roles related to
Computer Programming/AI/IT/Analytics/Computer Science The
...
Previous relevant Qualification of NSQF Level (3) with 3 Years
of experience in relevant field. Relevant Experience in job
roles related to Computer
Programming/AI/IT/Analytics/Computer Science The relevant
...
integration, communication, Data logging ,mission planning etc.) and non-functional
...
define the overall structure of the software, including modules for flight control, data
...
processing, utilize relevant programming languages (e.g., C++, Python, ROS) based on project
requirements.
...
KU4. Who may need to involve when developing tests or simulations for hardware and software
systems
...
30 50 - 20
PC1. Collaborate with stakeholders to document
functional (Flight control, Navigation,Payload
integration, communication, Data logging ,mission 3 6 - 2
planning etc.) and non-functional requirements
(performance, scalability, security etc.)
PC2. Create architectural diagrams that outline
the software components and their interactions,
define the overall structure of the software, 3 6 - 2
including modules for flight control, data
processing, and user interface.
PC3. Design navigation algorithms (e.g.,
5 9 - 4
waypoints, obstacle avoidance, path planning).
PC4. Develop flight control algorithms to manage
5 9 - 4
stabilization, speed, and performance parameters.
PC5. .Write the source code for each component,
focusing on flight control, navigation, and data
processing, utilize relevant programming 7 10 - 4
languages (e.g., C++, Python, ROS) based on
project requirements.
PC6. Ensure that the software is integrated with
drone hardware components (e.g., sensors, GPS, 7 10 - 4
motors).
#### NOS Total 30 50 - 20
...
simulated environments and real-world scenarios to ensure reliability and
safety
Description
...
Marks Marks Marks Marks
30 50 - 20
PC1. Employ simulation tools to test algorithms
2 4 - 1
and flight control without physical hardware
PC2. Validate the behavior and performance of
the software using a controlled virtual 2 4 - 1
environment
PC3. Conduct flight tests to evaluate the
4 5 - 1
software’s performance in real-world conditions
PC4. Monitor system behavior, assess
navigation accuracy, and verify data processing 4 5 - 1
efficiency during flights
PC5. Identify and resolve any issues or bugs
5 8 - 4
found during testing
PC6. Optimize algorithms for better
2 6 - 3
performance, reliability, and responsiveness
PC7. Document the code, including usage
instructions, algorithm explanations, and 2 6 - 3
system architecture
PC8. Update and refine the software based on
user inputs, testing results, and technology 4 6 - 3
advancements
PC9. Prepare the software for deployment on
5 6 - 3
the drone’s onboard systems
#### NOS Total 30 50 - 20
...
National Occupational Standards (NOS) Parameters
#### NOS Code SSC/N8436
Conduct thorough testing of drone system software in both simulated
#### NOS Name
environments and real-world scenarios to ensure reliability and safety
Sector IT-ITeS
Sub-Sector Future Skills
Occupation Web & Mobile Development
NSQF Level 4
...
SSC/N8435.Design the software
30 50 - 20 100 40
for the Drone system
SSC/N8436.Conduct thorough
testing of drone system
software in both simulated
30 50 - 20 100 40
environments and real-world
