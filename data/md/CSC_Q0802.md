# Qualification Pack: Capital Equipment - Instrumentation Technician
**QP Code**: `CSC/Q0802`  
...
Qualification Pack
Capital Equipment - Instrumentation
Technician
QP Code: CSC/Q0802
Version: 4.0
NSQF Level: 4
...
KU4. how to minimise risks from the hazards associated with carrying out mechanical
maintenance activities, such as handling oils, greases, stored pressure/force, use of complex
tools and equipment
...
KU10. use of various testing instruments such as multimetre, oscilloscope, logic probe, signal
...
KU22. the working purpose of individual units/components such as gauges and meters and how
they interact
...
range
KU25. the appropriate way of fitting instruments to avoid faulty readings caused by head
correction, poor flow past sensor, blockages, incorrect wiring, poor insulation or incorrect
materials
...
Marks Marks Marks Marks
Prepare for the maintenance activities 3 9 - -
PC1. prepare and update the relevant maintenance
1 3 - -
schedules and plans
PC2. perform appropriate risk assessments before
1 3 - -
testing and maintenance activities
PC3. coordinate with the operations and production
teams to ensure the availability of critical systems 1 3 - -
and spares parts
Carry out the maintenance activities 20 44 - -
PC4. use the correct and approved version of the
company and/or manufacturer’s drawings and 1 3 - -
maintenance documentation
PC5. follow the instructions in manufacturers'
manuals to perform test and maintenance 1 2 - -
activities
PC6. follow the recommended maintenance
schedules for critical systems, logging all repairs 1 2 - -
and inspections
PC7. carry out the maintenance activities on a
range of instrumentation and control equipment,
1 2 - -
following the appropriate techniques and
procedures
PC8. check the technical and mechanical systems
to ensure their operation within the specified 1 3 - -
parameters
PC9. conduct instrumentation evaluation for
hydraulic, pneumatic, mechanical, electrical and 1 2 - -
electronic measuring and control equipment
PC10. identify non-operational and malfunctioning
systems in a timely manner to prevent any 1 2 - -
damage or loss
PC11. conduct the appropriate tests related to the
1 2 - -
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC12. test the instrumentation system operations
1 2 - -
to diagnose problems
PC13. use the appropriate scientific and analytic
computer software, calculators, electronic probes,
1 2 - -
voltage and current meters to diagnose faults in
circuitry
PC14. coordinate with the relevant personnel to
evaluate the functioning of routine and emergency 1 2 - -
instruments and equipment
PC15. use the relevant testing devices to measure
and control pressure, flow, temperature, level, 1 2 - -
motion, force, and chemical makeup
PC16. adjust the system components and replace
1 2 - -
the defective parts, as required
PC17. coordinate with engineers and process
technicians to resolve the issues requiring their 1 2 - -
assistance
PC18. recommission the instrumentation system
appropriately, to return it to service following 1 2 - -
repair and replacement activities
PC19. ensure compliance with the applicable
policies, standards, and environmental and safety
1 2 - -
requirements while carrying out the required
instrument maintenance or replacement activities
PC20. follow the applicable organisational
procedure for the resolution of defects outside the 1 2 - -
planned schedule
PC21. carry out troubleshooting for test failures to
determine root causes and develop processes to 1 2 - -
avoid repeat failure
PC22. carry out appropriate documentation to
record the relevant information regarding the 1 3 - -
maintenance activities
PC23. follow the recommended practices to reduce
the cost of repairing instruments and equipment 1 3 - -
...
Marks Marks Marks Marks
Coordinate with the supervisor 3 9 - -
PC24. monitor the problem and update the
superior about progress or any delays in resolving 1 3 - -
the problem
PC25. coordinate with the supervisor or relevant
expert to resolve any issues which are out of 1 3 - -
authority or area of competence
PC26. identify appropriate improvements to the
maintenance procedures and coordinate with the 1 3 - -
supervisor for their implementation
Use resources optimally 4 8 - -
PC27. optimise the usage of electricity and other
2 4 - -
resources in various tasks and processes
PC28. connect the electrical tools and equipment
2 4 - -
