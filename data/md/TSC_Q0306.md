...
A Finished Package Checker-cum-Packer - Yarn conditioning should be able to carry out manual conditioning of the finished cone packages using yarn conditioning plant by following the standard
...
strapping machine, weigh scale, pallet wrapper, trolley, HDPE sack, twine, needle, strap, carton box, carton pads, PE covers, disk, packing slip, cone label, etc.
...
investigator or checker code, approvals such as OK, quality OK, tested OK, count, weight, etc.
...
etc.
- KU9. available types of packing tools and equipment such as packing fixer, needle, strapping machine, trolley, pallet packing machine, etc.
- KU10. importance of checking packages under UV light, lens, etc.
- KU11. SOP for cleaning defective cone packages
- KU12. tolerance of allowable weight variation in packages and the hessian bag, carton box, and pallet
...
Qualification Pack
- GS4. perform basic arithmetical calculations to calculate packing production, estimate packing material quantity, etc.
...
- KU7. measurement methods of finished package moisture content and YCP plant settings according to moisture level
