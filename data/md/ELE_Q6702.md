# Qualification Pack: Motor and Controller Design Engineer
**QP Code**: `ELE/Q6702`  
...
Qualification Pack
Motor and Controller Design Engineer
QP Code: ELE/Q6702
Version: 2.0
NSQF Level: 5
...
Qualification Pack
B.E./B.Tech (Degree in Electrical or Electronics
Engineering)
OR
Diploma (after 10th Electrical or Electronics
Minimum Educational Qualification & Engineering) with 2 Years of experience
Experience OR
Certificate-NSQF (Level-4 in the domain of EV /
Electrical / Mechanical /Automobile (Battery
System Assembly Operator) with 3 Years of
experience
...
KU8. functionalities of various transmission system components such as gear, clutch and
differentials
...
KU12. mechanisms of power transmission from battery to motor and then to power transmission
systems
...
Determining specifications of the Motor and
20 43 - -
Transmission Control system
PC1. interpret Electric Vehicle level specifications
2 4 - -
set out by the Customer / Management
PC2. translate EV specifications into Motor and
2 4 - -
Transmission Control system level specifications
PC3. list various design options / specifications
available at each component level of the Motor 2 4 - -
and Transmission Control system
PC4. evaluate each design option based on
2 4 - -
parameters such as safety, performance and cost
PC5. select a proper battery to generate
sufficient electrical power for movement of the 2 4 - -
vehicle
PC6. select specification of the motor for
2 4 - -
powering the electric vehicle
PC7. select specification of the motor controller
2 4 - -
for controlling energy flow from the motor
PC8. select specification of the gears, clutch and
differentials, necessary for transmitting power to 2 5 - -
the wheels
PC9. select specification of Transmission Control
2 5 - -
system
PC10. administer that the project is within the
2 5 - -
stipulated time and budget
Designing the Motor and Motor Controller 5 15 - -
PC11. employ cross-functional partners to
integrate Motor and Transmission into the final 1 3 - -
system
PC12. develop designing, building, and testing
1 3 - -
code to satisfy design requirements
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC13. design motor of the electric vehicle for
converting electrical energy into mechanical 1 3 - -
energy
PC14. design mounting arrangement for different
1 3 - -
types of motors for two, three and four-wheeler
PC15. design controller of the motor for
1 3 - -
controlling movement of the motor
Designing the Transmission and Transmission
5 12 - -
Control system
PC16. design power transmission system for
controlled transmission of power from the battery 2 3 - -
to wheel
PC17. design differential for controlling
1 3 - -
movement of the rear wheels
PC18. design system for transmitting power to
1 3 - -
one or more differentials
PC19. design system for gear reduction so that
1 3 - -
the wheels can rotate at different speed
#### NOS Total 30 70 - -
...
KU8. techniques to carry out temperature rise test, motor speed test and mechanical balancing
test
...
position, disengaging the wiring harness connector and using a digital Volt-Ohmmeter to
measure the resistance between sensor terminals
KU11. various causes for unbalancing such as asymmetric geometry, material in homogeneity,
manufacturing tolerances and elastic deformations of the flexible components during
operations
...
Marks Marks Marks Marks
Testing and validation of the design 10 30 - -
PC1. identify design areas where checking and
1 4 - -
testing is essential
PC2. use simple instructions which can be
2 4 - -
understood by the stakeholders
PC3. perform routine evaluation of the design
1 4 - -
for different parameters
PC4. test the entire designs of the power
transmission system as per design 1 4 - -
specifications
PC5. create prototype design of the activation,
2 5 - -
which can be validated, if necessary
PC6. comply with globally accepted regulatory
standards for technical specifications while 2 5 - -
testing
PC7. create logbook to maintain test records 1 4 - -
Performing temperature rise test 10 20 - -
PC8. use temperature tester with multi-channel
temperature monitoring, measuring & recording 2 5 - -
functions
PC9. inspect that the components and
assemblies do not get overheated during 3 5 - -
operation
PC10. perform temperature rise testing to
ensure temperature do not exceed specified 3 5 - -
limits
PC11. perform the test on bushings, instrument
transformers, disconnections and other 2 5 - -
equipment
Performing motor speed test 4 10 - -
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC12. examine the instantaneous speed of the
2 5 - -
vehicle using speedometer
PC13. perform vehicle speed sensor testing in
2 5 - -
order to test the speed sensor
Perform mechanical balancing test 6 10 - -
PC14. inspect the system for vibration caused
due to unbalancing after fitting of bearing and 3 5 - -
spindle
PC15. test to identify reasons for unbalancing 3 5 - -
#### NOS Total 30 70 - -
...
ELE/N6703.Design the Motor
and Transmission Control 30 70 - - 100 25
system
ELE/N6704.Inspect, test and
implement the Motor and 30 70 - - 100 25
Transmission Control system
