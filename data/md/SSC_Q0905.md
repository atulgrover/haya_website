# Qualification Pack: Analyst Endpoint Security
**QP Code**: `SSC/Q0905`  
...
courses related to Engg./ Science) with 3 Years of
experience Relevant Experience in job roles related in
IT/Computer Science/Cybersecurity. The relevant experience
...
in IT/Computer Science/Cybersecurity. The relevant
...
KU4. Organizational systems, procedures and tasks/checklists within the domain and how to use
these
...
Qualification Pack
KU5. How to engage with both internal and external specialists for support in order to resolve
...
30 50 - 20
PC1. Verify the scope of endpoint assets and
components to be monitored with authorized 3 5 - 2
persons
PC2. Participate in security operations center
3 5 - 2
shift schedules
PC3. Verify that endpoint security clients are
3 5 - 2
online and functional
PC4. Obtain reports and notifications from
endpoint security tools and respond per laid-out 3 5 - 2
processes
PC5. Use reports and logs to identify security
2 4 - 2
problems and monitor status and security events
PC6. Interpret the results of reports and
determine priorities and actions to remediate 2 4 - 2
situations
PC7. Respond to endpoint security client
2 4 - 2
messages and apply solutions accordingly
PC8. Monitor and troubleshoot an endpoint
security environment, its security management 2 3 - 1
tools, and client content delivery
PC9. Monitor and troubleshoot protection and
communication technologies using basic 2 3 - 1
troubleshooting and other monitoring tools
PC10. Troubleshoot and remediate virus
2 3 - 1
outbreaks or client installation failures.
PC11. Use AI for anomaly detection to identify
2 3 - 1
unusual patterns indicative of potential threats.
PC12. Implement automated responses to
2 3 - 1
...
Assessment Criteria for Outcomes
Marks Marks Marks Marks
PC13. Integrate threat intelligence feeds to
enhance monitoring capabilities and proactively 2 3 - 1
address emerging threats
#### NOS Total 30 50 - 20
...
Knowledge and Understanding (KU)
The individual on the job needs to know and understand:
KU1. Organization policies, procedures, standards, guidelines and service level agreements for
responding to information security incidents
KU2. Organizations knowledge base and how to access and update this
KU3. Limits of your role and responsibilities and who to seek guidance from
KU4. How to engage with both internal and external specialists for support in order to resolve
incidents and service requests
...
policy adjustments.
GS2. Precision in reviewing policies, configurations, and security logs to identify potential
...
GS4. Capacity to troubleshoot issues related to policy enforcement and implement effective
solutions swiftly.
...
Marks Marks Marks Marks
30 50 - 20
PC1. Enable debugging and gather logs for
5 8 - 3
technical support use
PC2. Upgrade and maintain the endpoint
5 7 - 3
security environment and clients
PC3. Manage and apply policies such as
antivirus, spyware protection, firewall, and 4 7 - 3
intrusion prevention.
PC4. Use IT analytics to generate
comprehensive reports from Endpoint 4 7 - 3
Protection
PC5. Ensure compliance with relevant
4 7 - 3
legislation, standards, policies, and procedures
PC6. Work within a zero-trust architecture,
ensuring all access is authenticated and 4 7 - 3
authorized
PC7. Implement micro-segmentation to
4 7 - 2
minimize lateral movement in case of a breach.
#### NOS Total 30 50 - 20
...
with teams.
GS4. Ability to work with various teams, including IT, network, and management, to ensure
effective security installation.
...
Marks Marks Marks Marks
30 50 -1 20
PC1. Receive instructions for the installation
5 8 - 3
of endpoint security tools
PC2. Create a database containing settings,
5 7 - 3
privileges, events, and security policies
PC3. Configure clients for automatic updates
4 7 - 3
and virus definition updates.
PC4. Use Mobile Device Management (MDM)
4 7 - 3
solutions for securing all mobile endpoints
PC5. Employ data encryption strategies to
protect sensitive information at rest and in 4 7 - 3
transit.
PC6. Integrate endpoint security tools with
cloud services to enhance visibility and 4 7 - 3
protection.
PC7. Conduct audits of cloud environments to
4 7 - 2
ensure robust endpoint protection.
#### NOS Total 30 50 - 20
...
National Occupational Standards (NOS) Parameters
#### NOS Code SSC/N0965
Carryout the Installation and Infrastructure Support for Endpoint
#### NOS Name
Security
Sector IT-ITeS
Sub-Sector
...
SSC/N0912.Conduct the end-
point security monitoring & 30 50 - 20 100 30
response
SSC/N0913.Carryout the
Endpoint Security Management 30 50 - 20 100 30
and Policy Enforcement
SSC/N0965.Carryout the
Installation and Infrastructure 30 50 - 20 100 30
