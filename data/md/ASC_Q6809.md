...
wiring harness and connectors, Electronic Control Unit (ECU), automatic lock system and other similar parts etc. to test its working status and expected conditions
- PC9. conduct breakdown maintenance and check the systems of the vehicle to find out root cause
of the problems like any leakage, short circuit in parts, breakage of wires and clamps, unusual contact of electrical wires with other parts etc. in the vehicle and discuss the same
...
(manufacturing and maintenance department) about maintenance activity done on the vehicle
#### Knowledge and Understanding (KU)
The individual on the job needs to know and understand:
...
- KU11. Standard Operating Procedures (SOP) recommended by OEM for using tools and equipment required
- KU12. how to collect and store consumables, spare parts, tools, etc. as per organisational procedures
